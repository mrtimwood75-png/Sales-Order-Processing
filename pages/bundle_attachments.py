...
def reset_session():
    keys = [
        ...
        "bundle_only_bundle_pdf_bytes",
        "bundle_only_bundle_pdf_name",
    ]
    for key in keys:
...
if uploaded_pdf is not None:
    ...
    if (
        ...
        st.session_state["bundle_only_bundle_pdf_bytes"] = None
        st.session_state["bundle_only_bundle_pdf_name"] = ""
...
if st.session_state.get("bundle_only_order_pdf_bytes"):
    ...
    if a2.button("Build Bundle PDF", use_container_width=True):
        try:
            ...
            st.session_state["bundle_only_bundle_pdf_bytes"] = bundle_bytes
            st.session_state["bundle_only_bundle_pdf_name"] = bundle_name
    ...
    if st.session_state.get("bundle_only_bundle_pdf_bytes"):
        st.download_button(
            "Download bundled PDF",
            data=st.session_state["bundle_only_bundle_pdf_bytes"],
            file_name=st.session_state.get("bundle_only_bundle_pdf_name", "customer.pdf"),
